...
$required = [
    ...
    'This is the language of the asset metadata, independent of the site default language.',
    'Availability',
    'All locales',
    'Selected locales',
    ...
    'Mark this media translation for deletion',
    'Deletion is applied when Core metadata is saved and never deletes the original metadata.',
    'This media translation will be deleted when you save Core metadata.',
