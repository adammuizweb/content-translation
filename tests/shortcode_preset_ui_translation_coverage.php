...
$required = [
    ...
    'This pane is locked to the content language. One media file can serve every language; translate only its metadata here.',
    'Add the original metadata in this content language. One uploaded file can serve every language.',
    'Ready',
    'Original metadata fallback',
    'Draft metadata',
    'Stale metadata',
    'Unavailable',
    'This media is not available for the content language.',
    'Use custom image URL slug',
    'Image URL slug',
    'Disabled uses the original image URL. Enabled creates a language-specific URL for the same media file.',
    'Choose a valid media URL language.',
    'This media URL was changed by another editor. Reload before saving.',
    'Media URL slug is too long.',
    'This media URL slug is already in use for that language.',
];
$files = [
