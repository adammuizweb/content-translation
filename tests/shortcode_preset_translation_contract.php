...
$check(($manifest['version'] ?? '') === '1.16.4' && ($manifest['requires']['jyavani'] ?? '') === '>=2.3.122' && str_contains((string)($manifest['assets']['css'][0] ?? ''), 'v=1.16.4'), 'manifest keeps version/cache key aligned and requires the Core public media response contract');
