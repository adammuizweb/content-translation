...
$check(($manifest['version'] ?? '') === '1.16.9' && ($manifest['requires']['jyavani'] ?? '') === '>=2.3.130' && str_contains((string)($manifest['assets']['css'][0] ?? ''), 'v=1.16.9'), 'manifest keeps version/cache key aligned and requires the Core content-list and public media contracts');
