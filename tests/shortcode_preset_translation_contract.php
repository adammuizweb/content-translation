...
$check(($manifest['version'] ?? '') === '1.18.0' && ($manifest['requires']['jyavani'] ?? '') === '>=2.3.148' && str_contains((string)($manifest['assets']['css'][0] ?? ''), 'v=1.18.0'), 'manifest keeps version/cache key aligned and requires the scoped Core list and editor contracts');
