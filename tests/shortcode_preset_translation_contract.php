...
$check(($manifest['version'] ?? '') === '1.13.0' && ($manifest['requires']['jyavani'] ?? '') === '>=2.3.95' && str_contains((string)($manifest['assets']['css'][0] ?? ''), 'v=1.13.0'), 'manifest keeps version/cache key and requires workflow and multilingual theme Core contracts');
