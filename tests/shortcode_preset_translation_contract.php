...
$check(($manifest['version'] ?? '') === '1.19.0' && ($manifest['requires']['jyavani'] ?? '') === '>=2.3.149' && str_contains((string)($manifest['assets']['css'][0] ?? ''), 'v=1.19.0'), 'manifest keeps version/cache key aligned and requires the Category-aware Core list and editor contracts');
