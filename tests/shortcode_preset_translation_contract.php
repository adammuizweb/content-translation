...
$check(($manifest['version'] ?? '') === '1.12.2' && ($manifest['requires']['jyavani'] ?? '') === '>=2.3.81' && str_contains((string)($manifest['assets']['css'][0] ?? ''), 'v=1.12.2'), 'manifest keeps version/cache key and requires locale-aware search Core');
