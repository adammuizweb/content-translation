...
$check(($manifest['requires']['jyavani'] ?? '') === '>=2.3.96', 'manifest requires transaction-scoped workflow Core 2.3.96');
...
$check(str_contains($helpers, 'ct_user_can_workspace') && str_contains($helpers, 'ct_user_can_translate_post'), 'shared helpers intersect workspace and source permissions');
