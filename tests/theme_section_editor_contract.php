...
$check(str_contains($sources['helpers'], "'version' => 8") && str_contains($sources['helpers'], "'theme_section_translation_metadata'"), 'versioned export includes source verification metadata');
