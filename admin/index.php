...
<div class="ct-admin ct-hub">
  ...
  <section class="ct-hub-grid">
    ...
    <a class="ct-hub-card ct-hub-card--primary" href="<?= h($selfUrl . '/shortcodes') ?>"><i>06</i><strong><?= __('Shortcodes') ?></strong><span><?= __('Translate Shortcode Preset management titles and localized kicker text without changing query or layout configuration.') ?></span><b><?= __('Manage Shortcode Presets') ?> →</b></a>
