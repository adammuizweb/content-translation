...
if (!function_exists('ct_shortcode_preset_override_keys')) {
    ...
    function ct_shortcode_preset_ui_translations(): array {
        return [
            ...
            'This is the language of the asset metadata, independent of the site default language.' => ['Ini adalah bahasa metadata aset, terpisah dari bahasa bawaan situs.', 'Dies ist die Sprache der Asset-Metadaten, unabhängig von der Standardsprache der Website.'],
            ...
            'Alternate-locale metadata' => ['Metadata bahasa alternatif', 'Metadaten anderer Sprachen'],
            ...
            'Mark this media translation for deletion' => ['Tandai terjemahan media ini untuk dihapus', 'Diese Medienübersetzung zum Löschen markieren'],
            'Deletion is applied when Core metadata is saved and never deletes the original metadata.' => ['Penghapusan diterapkan saat metadata Core disimpan dan tidak pernah menghapus metadata asli.', 'Die Löschung wird beim Speichern der Core-Metadaten ausgeführt und löscht niemals die Originalmetadaten.'],
            'This media translation will be deleted when you save Core metadata.' => ['Terjemahan media ini akan dihapus saat Anda menyimpan metadata Core.', 'Diese Medienübersetzung wird beim Speichern der Core-Metadaten gelöscht.'],
