...
if (!function_exists('ct_shortcode_preset_override_keys')) {
    ...
    function ct_shortcode_preset_ui_translations(): array {
        return [
            ...
            'All locales keeps every language selected. Choose Selected locales to customize availability.' => ['Semua bahasa mempertahankan setiap bahasa tetap terpilih. Pilih Bahasa terpilih untuk menyesuaikan ketersediaan.', 'Alle Sprachen hält jede Sprache ausgewählt. Wählen Sie Ausgewählte Sprachen, um die Verfügbarkeit anzupassen.'],
            ...
            'Source thumbnail' => ['Gambar mini sumber', 'Quell-Vorschaubild'],
            ...
            'Use custom image URL slug' => ['Gunakan slug URL gambar khusus', 'Benutzerdefinierten Bild-URL-Slug verwenden'],
            'Image URL slug' => ['Slug URL gambar', 'Bild-URL-Slug'],
            'Disabled uses the original image URL. Enabled creates a language-specific URL for the same media file.' => ['Saat dinonaktifkan, URL gambar asli digunakan. Saat diaktifkan, URL khusus bahasa dibuat untuk berkas media yang sama.', 'Deaktiviert wird die ursprüngliche Bild-URL verwendet. Aktiviert wird eine sprachspezifische URL für dieselbe Mediendatei erstellt.'],
